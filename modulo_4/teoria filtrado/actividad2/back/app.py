...
def login():
    """
    Endpoint para verificar usuario y contraseña desde users.json
    """
    try:
        # Agregar CORS headers para permitir requests desde el navegador
        response = Response()
        ...
        # Verificar que el archivo users.json existe
